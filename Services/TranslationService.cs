    ...
    public class TranslationService
    {
        ...
        private void LoadTranslations()
        {
            ...
            _translations["Russian"] = new Dictionary<string, string>
            {
                ...
                { "Scene1_VillageAppears", "Наконец, деревня появилась из-за холмов и деревьев." },
                { "Scene1_JourneyText_1", "Хотя путешествие было долгим и изнурительным, этот вид не приносит радости." },
                { "Scene1_JourneyText_2", "Вы знаете, что ваше появление там вызовет только подозрения. Лучшее, на что вы можете надеяться, это то, что на вас будут смотреть умоляюще." },
                { "Scene1_ChainsText", "Цепи звякали на ваших плечах, словно напоминая о себе. Они держат чёрную печь на вашей спине. То, что горит внутри неё, светится неестественным красным светом." },
                { "Scene1_CurseText", "Ваше проклятие, происхождение которого вы помните смутно, почти стёртые воспоминания. Иногда кажется, что вы можете вспомнить фрагмент прошлого, но он тут же ускользает и растворяется без следа." },
                { "Scene1_LastSteps", "Ещё несколько шагов с комьями мокрого снега, прилипшими к вашей одежде. Последний рывок, и вы сможете немного отдохнуть." },
                { "Scene1_VillageNoise", "Вы слышите шум деревни—разговоры, звук молотков, пронзительные крики детей где-то вдали." },
                { "Scene1_MainStreet", "Фон меняется на главную улицу деревни." },
